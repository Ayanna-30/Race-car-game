console.log("Press an arrow key to move car 1 (the blue car). Press a, w, s, or d to move car 2 (the red car).")
canvas = document.getElementById('myCanvas');
ctx = canvas.getContext("2d");

car1_width = 120;
car1_height = 70;
car1_image = "car_image1.png";
car1_x = 10;
car1_y = 10;

car2_width = 120;
car2_height = 70;
car2_image = "car_image2.png";
car2_x = 10;
car2_y = 100;

background_image = "car_racing_gif.gif";
